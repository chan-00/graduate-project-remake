...
function OfferBoard() {
    ...
    useEffect(() => {
        ...
        functionBoardList("Team", setLoadingStatus, setTeamBoardList, "post_id desc", setCurrentPageNum);
    }, []);
    ...
    const handleChangeArraySort = (e) => {
        ...
        setLoadingStatus(false);
        functionBoardList("Team", setLoadingStatus, setTeamBoardList, e.target.value, setCurrentPageNum);
    }
