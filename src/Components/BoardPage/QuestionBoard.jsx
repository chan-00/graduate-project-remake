...
function QuestionBoard() {
    ...
    useEffect(() => {
        ...
        functionBoardList("Question", setLoadingStatus, setTeamBoardList, "post_id desc", setCurrentPageNum);
    }, []);
    ...
    const handleChangeArraySort = (e) => {
        ...
        setLoadingStatus(false);
        functionBoardList("Question", setLoadingStatus, setTeamBoardList, e.target.value, setCurrentPageNum);
    }
