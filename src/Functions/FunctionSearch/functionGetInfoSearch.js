function functionGetInfoSearch(setLoadingStatus, setSearchResultArray, searchTextRef, setSearchText, setStartIndex, setPreviousIndex) {
    ...
    const apiUrl = `https://www.googleapis.com/customsearch/v1?key=${process.env.REACT_APP_SEARCH_API_KEY}&cx=${process.env.REACT_APP_CX_VALUE}&q=${searchTextRef.current.value}`;
