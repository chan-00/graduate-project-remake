...
function functionGetTeamMemberList(currentClickTeam, setTeamMemberArray, setLoadingStatus, setTeamApplyArray, setUserProfileInfo, setApplyUserProfileInfo) {
    //팀 상세 페이지 첫 렌더링 시 그 팀에 대한 정보와 해당 계정이 팀에 속해 있는지에 대한 여부 값을 받아오는 코드이다.
    axios.post("http://" + process.env.server_ip + ":8000/back/detail_team_list2/", {
